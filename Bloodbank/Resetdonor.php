...
function sendMail($email,$reset_token)
{
    ...
    try {
        ...
        <a href='http://localhost/Bloodbank/updatepassworddonor.php?D_email=$email &resettoken=$reset_token'>
        Reset password </a>";
...
if(isset($_POST['reset']))
{
  $resetmail=$_POST['resetmail'];
    $sql="SELECT*FROM `donor` WHERE `D_email`='$resetmail'";
    //echo"$sql";
    ...
    if($result)
    {
        if(mysqli_num_rows($result)==1)
        {
            ...
            $upadte = "UPDATE `donor` SET `resettoken`='$reset_token',`resettokenexpaire`='$date' WHERE `D_email` ='$resetmail'";
    ...
    <div class="row px-3">
      <div class="col-lg-6 col-xl-5 card flex-row mx-auto px-0">
        ...
        <div class="card-body">
          ...
          <form action ="Resetdonor.php" method="POST">
          <div class="form-box px-3">
            ...
            <div class="mb-3">
              ...
              <a href="Donornew.php" class="forget-link">
                LOGIN PAGE
              </a>
